...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Algorithm [] algos = { Insersion.getInstance(), Shell.getInstance(),Bubble.getInstance(), Bucket.getInstance(), Merge.getInstance(), Selection.getInstance()};
